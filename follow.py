...
def follow_people(people_to_follow):
    ...
    i = 0
    print(f"len of people to follow {len(people_to_follow)}")
...
def create_people_to_follow():
    ...
    print("alsdjfhaskjdfh")
    print(len(new_account.GetFriendIDs()))
    people_to_follow = people_to_follow - OrderedSet(new_account.GetFriendIDs())
